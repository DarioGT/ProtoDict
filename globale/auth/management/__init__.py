...
from globale.auth import models as auth_app
...
signals.post_syncdb.connect(create_permissions,
    dispatch_uid = "globale.auth.management.create_permissions")
signals.post_syncdb.connect(create_superuser,
    sender=auth_app, dispatch_uid = "globale.auth.management.create_superuser")
