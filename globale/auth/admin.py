...
from globale.auth.forms import UserCreationForm, UserChangeForm, AdminPasswordChangeForm
from globale.auth.models import User, Group
...
class GroupAdmin(globale.admin.ModelAdmin):
    search_fields = ('name',)
    ordering = ('name',)
    filter_horizontal = ('permissions',)

class UserAdmin(globale.admin.ModelAdmin):
    ...
    def get_form(self, request, obj=None, **kwargs):
        ...
        if obj is None:
            defaults.update({
                'form': self.add_form,
                'fields': globale.admin.util.flatten_fieldsets(self.add_fieldsets),
            })
    ...
    def user_change_password(self, request, id):
        ...
        adminForm = globale.admin.helpers.AdminForm(form, fieldsets, {})
...
globale.admin.site.register(Group, GroupAdmin)
globale.admin.site.register(User, UserAdmin)
