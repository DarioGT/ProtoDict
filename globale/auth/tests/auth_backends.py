...
from globale.auth.models import User, Group, Permission, AnonymousUser
...
class BackendTest(TestCase):
    ...
    backend = 'globale.auth.backends.ModelBackend'
...
class RowlevelBackendTest(TestCase):
    ...
    """
    backend = 'globale.auth.tests.auth_backends.SimpleRowlevelBackend'
...
class AnonymousUserBackendTest(TestCase):
    ...
    backend = 'globale.auth.tests.auth_backends.AnonymousUserBackend'
...
class NoAnonymousUserBackendTest(TestCase):
    ...
    """
    backend = 'globale.auth.tests.auth_backends.NoAnonymousUserBackend'
...
class InActiveUserBackendTest(TestCase):
    ...
    backend = 'globale.auth.tests.auth_backends.InActiveUserBackend'
...
class NoInActiveUserBackendTest(TestCase):
    ...
    """
    backend = 'globale.auth.tests.auth_backends.NoInActiveUserBackend'
