...
from globale.auth.backends import RemoteUserBackend
...
class RemoteUserTest(TestCase):
    ...
    urls = 'globale.auth.tests.urls'
    middleware = 'globale.auth.middleware.RemoteUserMiddleware'
    backend = 'globale.auth.backends.RemoteUserBackend'
...
class RemoteUserNoCreateTest(RemoteUserTest):
    ...
    backend =\
        'globale.auth.tests.remote_user.RemoteUserNoCreateBackend'
...
class RemoteUserCustomTest(RemoteUserTest):
    ...
    backend =\
        'globale.auth.tests.remote_user.CustomRemoteUserBackend'
